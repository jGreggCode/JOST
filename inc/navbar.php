...
<div class="col-lg-2">
    ...
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link" id="v-pills-reports-tab" data-toggle="pill" href="#v-pills-reports" role="tab" aria-controls="v-pills-reports" aria-selected="false"><i class='bx bxs-report' ></i> Reports</a>
        <a class="nav-link" id="v-pills-reports-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-reports" aria-selected="false"><i class='bx bx-user-circle' ></i> My Profile</a>
    </div>
</div>