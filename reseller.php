<?php
	...
	if(!isset($_SESSION['loggedIn']) || $_SESSION['usertype'] !== 'Reseller'){
		...
		?>
		 <div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent">
			  <div class="tab-pane fade show" id="v-pills-" role="tabpanel" aria-labelledby="v-pills-item-tab">
					 ...
					 <form> 
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						 ...
						 <div class="form-group col-md-3">
							<label for="vendorDetailsVendorID">UserUse the grid below to search User's details ID</label>
				  ...
				  <div class="card-body">										
					...
					<div class="tab-content">
						...
						<div id="saleSearchTab" class="container-fluid tab-pane fade">
							<br>
							<p>Use the grid below to search your sale details</p>
							<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
							<script type="text/javascript">
								<?php 
								
									$saleDetailsSearchSql = 'SELECT itemName, quantity FROM sale WHERE sellerID = :sellerID';
									$saleDetailsSearchStatement = $conn->prepare($saleDetailsSearchSql);
									$saleDetailsSearchStatement->execute(['sellerID' => $_SESSION['userid']]);
									$salesData = [];
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#vendorReportsTab">Suppliers</a>
						</li>
					</ul>
